...
// COMPLETION CHECK — FULL HAND-OFF
  ...
  update(dt) {
    ...
    // ALSO KEEP TICKING WHILE GLITCH IS WINDING DOWN (rt.active GOES FALSE BEFORE GLITCH FINISHES)
    const rt = this._rageTransform;
    if (rt.active) this._updateRageTransform(dt);
    else if (rt.glitchActive) {
