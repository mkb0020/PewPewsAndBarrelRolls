...
export const CONFIG = {
  ...
  SHOOTING: {
    ...
    CROSSHAIR_CENTER_PULL: 0.9,       // HOW HARD CROSSHAIR SNAPS TO CENTER AT SCREEN EDGE (0-1)
    CROSSHAIR_INNER_LAG: 0.20,         // INNER RETICLE CHASE SPEED (SNAPPY)
    CROSSHAIR_OUTER_LAG: 0.09,         // OUTER BRACKETS CHASE SPEED (TRAILS BEHIND INNER)
    CROSSHAIR_MAX_SEPARATION: 50,      // MAX PIXEL DISTANCE BETWEEN INER AND OUTER RETICLES
