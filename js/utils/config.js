...
// VALUES BELOW ARE NOT FINALIZED 
  ...
  WORM_BOSS: {
    LUNGE_DAMAGE:         30,   // HP DEALT ON A SUCCESSFUL LUNGE BITE — TRIGGERS INVINCIBILITY FRAMES
    LUNGE_SHAKE_STRENGTH: 14,   // px — SCREEN SHAKE MAGNITUDE ON BITE IMPACT
    LUNGE_SHAKE_DURATION: 0.28, // SECONDS — SHAKE DECAY TIME
  },
  ...
  CELLULAR_ATTACK: {
    ...
    CELLULAR_SPIT_DURATION: 0.5,
    CELLULAR_SEED_DELAY:    0.4,
    CELLULAR_MAX_DURATION:  10,
    ...
    GLOW_HARMLESS:         3, // WAS 5 - TESTING TO SEE IF THIS HELPS PERFORMANCE
    GLOW_DAMAGING:         5,  // WAS 9 - TESTING TO SEE IF THIS HELPS PERFORMANCE
    GLOW_BREAK:            7,  // WAS 13 - TESTING TO SEE IF THIS HELPS PERFORMANCE
    GLOW_DOOM:            10,  // WAS 15 - TESTING TO SEE IF THIS HELPS PERFORMANCE
    BREAK_PULSE_HZ:        1.2, 
    DOOM_PULSE_HZ:         2.2,
  },
